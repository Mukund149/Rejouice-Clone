...
## Overview
This project is a clone of the **Rejouice** website, an interactive web experience focused on modern web design, animations, and smooth user interactions. The clone replicates the core features of Rejouice’s landing page, including custom cursor animations, hover-to-play video reels, text rise animations, and smooth scroll interactions, all implemented using **GSAP** and **Locomotive Scroll**.

The goal of this project was to reverse-engineer the website’s intricate animations and interactions to create a near-identical experience while learning advanced front-end web development techniques.
